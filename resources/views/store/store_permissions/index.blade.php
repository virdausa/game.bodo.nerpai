        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="px-6">
                        <h3 class="text-lg dark:text-white font-bold">Manage Store Permissions</h3>
                        ...
                        <div
                            ...
                            <!-- <div
                                ...
                                <div
                                    ...
                                    <x-button-add :route="route('store_permissions.create')" text="Create Permission" />
                                </div>
                            </div> -->
                                            ...
                                            <x-table-tr>
                                                ...
                                                <x-table-td>
                                                    <div class="flex inline">
                                                        <!-- <x-button-edit :route="route('store_permissions.edit', $permission->id)" />
                                                        <x-button-delete :route="route('store_permissions.destroy', $permission->id)" /> -->
                                                    </div>
                                                </x-table-td>
                                            </x-table-tr>
                                        @endforeach
