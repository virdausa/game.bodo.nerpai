        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <div class="p-6 text-gray-900">
                    <h3 class="text-lg dark:text-white font-bold">Store Role Access</h3>
                        ...
                        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                            <div
                                ...
                                <!-- <div
                                    ...
                                    <x-button-add :route="route('store_roles.create')" text="Add Role" />
                                </div> -->
                            </div>
                                        ...
                                        <x-table-tr>
                                            ...
                                            <x-table-td>
                                                <div class="flex inline">
                                                    <!-- <x-button-edit :route="route('store_roles.edit', $role->id)" />
                                                    <x-button-delete :route="route('store_roles.destroy', $role->id)" /> -->
                                                </div>
                                            </x-table-td>
                                        </x-table-tr>
                                    @endforeach
